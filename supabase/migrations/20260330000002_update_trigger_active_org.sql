-- Migration: Update handle_new_user trigger to set active_org_id
-- Keeps original order: user first (needed for organizations.owner_id FK),
-- then org, then updates user's active_org_id within the same transaction.
